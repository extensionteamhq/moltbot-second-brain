...
## For Consideration
*Tasks Molly recommends — awaiting Mateo's review*
...
- [ ] **Dirt Roamers Email Sequence** — Draft a 5-email nurture sequence for land sellers (cold outreach → follow-up → offer). Ready to load into GoHighLevel. (Added: 2026-02-07)
...
- [ ] **Social Media Content Calendar** — Build a 30-day content calendar template for Twitter/X and LinkedIn with post ideas aligned to Dirt Roamers + Anchor & Staff brand positioning. (Added: 2026-02-07)

---

## Research & Plan
*Approved for research — Molly to fully research and create implementation plan*

<!-- - [ ] **Task Name** — Description | Plan: [link to plan doc] -->

---

## Implementing
*Approved plan — Molly actively working on this*
...
<!-- - [x] **Task Name** — Description (Completed: YYYY-MM-DD) -->
